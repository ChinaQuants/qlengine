...
void BondTest::testCachedCTBZero() {
    ...
    */
    ...
    Actual365Fixed accrualDayCounter(Actual365Fixed::NoLeap);
    BusinessDayConvention paymentConvention = Unadjusted;
    CTBZeroBond bond(settlementDays, calendar, faceAmount, issuePrice, issueDate, accrualDayCounter, maturity,
                     paymentConvention, redemption);
    const Real cleanPrice = 97.5988;
    Compounding compounding = Simple;
    Frequency frequency = Annual;
    Real accrual = bond.accruedAmount();
    Real yield = bond.yield(cleanPrice, accrualDayCounter, compounding, frequency);
...
void BondTest::testCachedCTBFixed() {
    ...
    */
    ...
    Date today(2, Dec, 2013);
    Settings::instance().evaluationDate() = today;
    CTBFixedBond bond(issueDate, settlementDays, faceAmount, startDate, maturity, tenor, coupons, accrualDayCounter);
